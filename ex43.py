...
# class scene is-a object and has-a function named enter that accepts the pass
# parameter
class Scene(object):
    def enter(self):
        pass
...
class Engine(object):
    #class engine has-a __init__ that accepts the self and scene_map parameters
    def __init__(self, scene_map):
        #from self set the scene_map parameter to the scene map passed
        self.scene_map = scene_map
    # class engine has-a play function that accepts the self parameter
    def play (self):
        #set the current_scene variable to opening_scene from scene_map
...
class CentralCorridor(Scene):
    def enter(self):
        ...
        Armory, put it in the bridge, and blow the ship up after into an escape
        pod. 
        ...
        if action == "shoot!":
            print """Quick on the draw you yank out your blaster and fire it
            at the Gothon.
            His clown costume is flowing and moving around his body, which
            throws off your aim. Your laser hits his costume but misses him
            entirely. This completely ruins his brand new costume his mother
            ...
            In the middle of your artful dodge your foot slips and you band
            ...
            Lbhe zbgure vf fb sng, jura fur fvgh nebhaq gur ubhfr, fur fvgf
            nebhaq gur ubhfr.
...
class LaserWeaponArmory(Scene):
    def enter(self):
        print """You do a dive roll into the Weapon Armory, crowd and scan the
        ...
        if guess == code:
            ...
            out. You grab the neutron bomb and run as fast as you can to the
...
class TheBridge(Scene):
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            bomb. You die knowing they will probably blow up when it goes
            off."""
            return 'death'
            ...
            the bomb on the floor, pointing your blaster at it. 
            You then jump back through the door, punch the close button and
            blast the lock so the Gothon's can't get out.
...
class EscapePod(Scene):
    def enter(self):
        ...
        to the chamber with the escape pods, and now need to pick one to take.
        Some of them could be damaged but you don't have time to look. There's
        ...
        if int(guess) != good_pod:
             ...
             The pod escapes out into the void of space, then implodes as
             the hull ruptures, crushing your body into jam jelly.""" % guess
             return 'death'
        else:
            print """You jump easily into pod %s and hit the eject button.
